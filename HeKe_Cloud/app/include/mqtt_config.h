...
#define MQTT_HOST            "39.106.100.57" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            1883    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID       "wangqi"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
...
#define MQTT_PASS            "pubilc" // you MQTT login password, same as above
#define STA_SSID "whoisLily"    // your AP/router SSID to config your device networking
#define STA_PASS "4EC24182" // your AP/router password
